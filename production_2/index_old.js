...
const tablasgeneralesRouter = require('./api/recursos/tablasgenerales/tablasgenerales.routes');
...
app.get('/',(req,res)=>{
    res.send('inicialización de la api emc')
})
...
app.use('/api/tablasgenerales',tablasgeneralesRouter);
